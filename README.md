...
- Pass all test cases under `TestGol`, `TestAlive` and `TestPgm`.     //done
- Use the correct number of workers as requested in `gol.Params`.     //done
- Display the live progress of the game using SDL.                    //done
- Ensure that all keyboard control rules work correctly.              //done
- Use benchmarks to measure the performance of your parallel program. //done ？？
- The implementation must be free of deadlocks and race conditions.   //done
